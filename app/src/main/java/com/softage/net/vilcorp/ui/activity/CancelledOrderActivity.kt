...
import com.softage.net.vilcorp.databinding.ActivityCancelledOrderBinding
...
class CancelledOrderActivity : AppCompatActivity() {
    private var binding: ActivityCancelledOrderBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCancelledOrderBinding.inflate(layoutInflater)
    ...
    private fun initToolbar() {
        ...
        supportActionBar!!.title = "Cancelled Orders"
        ...
        call.enqueue(object : Callback<ArrayList<CancelOrderListSuccess>> {
            override fun onResponse(
                ...
                if (response.isSuccessful && data != null) {
                    ...
                    adapter = CancelOrderAdapter(applicationContext,leadList)
